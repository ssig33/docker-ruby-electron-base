...
RUN wget https://nodejs.org/dist/v7.9.0/node-v7.9.0-linux-x64.tar.xz && tar xvf node-v7.9.0-linux-x64.tar.xz &&  rm node-v7.9.0-linux-x64.tar.xz && cd node-v7.9.0-linux-x64 && cp -r * /usr/local && cd ../ && rm -rf node* && npm install -g npm yarn
