...
RUN wget https://nodejs.org/dist/v8.4.0/node-v8.4.0-linux-x64.tar.xz && tar xvf node-v8.4.0-linux-x64.tar.xz &&  rm node-v8.4.0-linux-x64.tar.xz && cd node-v8.4.0-linux-x64 && cp -r * /usr/local && cd ../ && rm -rf node* && npm install -g npm yarn
